...
--
-- Host: localhost
-- Generation Time: Sep 11, 2017 at 01:00 PM
...
(3, 3, 8, 4, 'just random title here', 'just-random-title-here', 'description allows bbcode', 'street number', NULL, NULL, '300.000', '8848585', 'NULL', NULL, '2009-07-07 07:58:40', '2009-07-07 08:58:40', NULL, NULL, 1, 1, NULL, NULL, 0),
...
(1, 1, 'admin', 'admin@gmail.com', NULL, 'Jobs', 2, 'Madrid', 'some nice title here', 'description allows bbcode', 'optional address', '0.000', '949494949', '2009-06-18 23:04:03', 'http://open-classifieds.com', 'http://lorempixel.com/1200/800/technics/', 'http://lorempixel.com/1200/800/technics/', '', '', 1),
(2, 2, 'Jermaine Doe', 'user@gmail.com', NULL, 'House', 3, 'London', 'another great title', 'description allows bbcode', '', '5.000', '419949494', '2009-06-29 12:55:03', 'NULL', 'http://lorempixel.com/1200/800/abstract/', '', '', '', 1),
(3, 3, 'Gary Doe', 'gazzasdasd@gmail.com', NULL, 'Part Time', 4, 'Barcelona', 'just random title here', 'description allows bbcode', 'street number', '300.000', '8848585', '2009-07-07 08:58:40', 'NULL', 'http://lorempixel.com/1200/800/people/', '', '', '', 1),
...
(1, 'Home category', 0, '2017-09-11 11:56:44', 0, 0, 'all', 'root category', '0.00', NULL, 0),
...
('payment', 'alternative', ''),
('general', 'analytics', ''),
('general', 'api_key', 'ztv7f@zt4fe@tswyh@45zag3$5jf2e3e'),
...
(10, 'en_UK', 0, 'Advertisement `[AD.TITLE]` is created on [SITE.NAME]!', 'ads-to-admin', 'Click here to visit [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(11, 'en_UK', 0, 'Advertisement `[AD.TITLE]` is sold on [SITE.NAME]!', 'ads-sold', 'Order ID: [ORDER.ID]\n\nProduct ID: [PRODUCT.ID]\n\nPlease check your account for the incoming payment.\n\nClick here to visit [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
...
(19, 'en_UK', 0, 'New reply: [TITLE]', 'messaging-reply', '[URL.QL]\n\n[DESCRIPTION]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
...
(146, 'es_ES', 0, '¡Anuncio `[AD.TITLE]` ha sido creado en [SITE.NAME]!', 'ads-to-admin', 'Clic aquí para visitarlo [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(147, 'es_ES', 0, '¡Anuncio `[AD.TITLE]` ha sido vendido en [SITE.NAME]!', 'ads-sold', 'ID de la orden: [ORDER.ID]\r\n\r\nID del producto: [PRODUCT.ID]\r\n\r\nPor favor, verifica tu cuenta para el pago recibido.\r\n\r\nClic aquí para visitar [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
...
(169, 'fr_FR', 0, 'Bonjour [USER.NAME]!', 'user-profile-contact', 'L\'utilisateur [Email.SENDER] [EMAIL.From] a un message pour vous: [EMAIL.SUBJECT] [EMAIL.BODY]. Cordialement,', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(170, 'fr_FR', 0, 'L\'annonce `[AD.NAME]` a été créée sur [SITE.NAME]!', 'ads-user-check', 'Bonjour [USER.NAME], l\'annonce a été créée avec votre compte [USER.NAME]! Vous pouvez visiter ce lien pour Cliquez ici pour accéder à votre annonce: [URL.AD] Si vous n\'êtes pas l\'auteur de cette annonce, cliquez sur le lien pour nous contacter: [URL.CONTACT].', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(171, 'fr_FR', 0, 'L\'annonce `[AD.TITLE]` vient d\'être publiée sur [SITE.NAME]!', 'ads-subscribers', 'Bonjour, Vous êtes peut être intéressé(e) par cette nouvelle annonce! Cliquez sur ce lien pour Cliquez ici pour accéder à votre annonce: [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(172, 'fr_FR', 0, 'L\'annonce `[AD.TITLE]` vient d\'être créée sur [SITE.NAME]!', 'ads-to-admin', 'Cliquez ici pour voir l\'annnonce [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(173, 'fr_FR', 0, 'L\'annonce `[AD.TITLE]` a été vendue sur [SITE.NAME]!', 'ads-sold', 'Numéro de commande: [ORDER.ID] ID de produit: [PRODUCT.ID] Veuillez svp vérifier votre compte pour le paiement entrant. Cliquez ici pour accéder à votre annonce: [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(174, 'fr_FR', 0, 'L\'annonce `[AD.TITLE]` est en rupture de stock sur [SITE.NAME]!', 'out-of-stock', 'Bonjour [USER.NAME]. Comme votre annonce est en rupture de stock, il n\'est pas posible pour les visiteurs du site de la voir. Si vous souhaitez augmenter sa disponibilité et ainsi activer votre annonce, veuillez svp cliquer sur le lien suivant: [URL.EDIT]. Cordialement!', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(175, 'fr_FR', 0, 'Reçu pour votre commande [ORDER.DESC] # [ORDER.ID]', 'new-order', 'Bonjour [USER.NAME], Merci pour votre commande [ORDER.DESC]. Veuillez svp régler votre commande et procéder à son paiement ici: [URL.CHECKOUT]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(176, 'fr_FR', 0, 'Votre annonce [AD.NAME] a expiré', 'ad-expired', 'Bonjour [USER.NAME], Votre annonce [AD.NAME] a expiré. Veuillez svp vérifier votre annonce ici: [URL.EDITAD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(177, 'fr_FR', 0, 'L\'annonce `[AD.TITLE]` a été achetée sur [SITE.NAME]!', 'ads-purchased', 'Numéro de commande: [ORDER.ID] ID du produit: [PRODUCT.ID] Pour toute question ou demande veuillez svp contacter l\'administrateur du site [SITE.NAME] Cliquez ici pour accéder à votre annonce: [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(178, 'fr_FR', 0, 'Mot de passe modifié [SITE.NAME]', 'password-changed', 'Bonjour [USER.NAME], Votre mot de passe a été changé. Voici vos nouvelles informations de connexion: Email: [USER.EMAIL] Mot de passe: [USER.PWD] . Pour des raisons de sécurité, nous ne gardons pas votre mot de passe original. Cordialement!', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(179, 'fr_FR', 0, 'Votre annonce [AD.NAME] va expirer', 'ad-to-expire', 'Bonjour [USER.NAME], Votre annonce [AD.NAME] va bientôt expirer. Veuillez svp vérifier votre annonce en cliquant sur ce lien: [URL.EDITAD]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(180, 'fr_FR', 0, 'Nouvelle réponse: [TITRE]', 'messaging-reply', '[URL.QL]\r\n\r\n[DESCRIPTION]', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(181, 'fr_FR', 0, '[FROM.NAME] vous a envoyé un message direct', 'messaging-user-contact', 'Bonjour [TO.NAME], [FROM.NAME] a un message pour vous: [description] [URL.QL] Cordialement!', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
...
(183, 'fr_FR', 0, 'Bonjour [TO.NAME]!', 'messaging-ad-contact', 'Vous avez été contacté au sujet de votre annonce: `[AD.NAME]`. L\'utilisateur [FROM.NAME] a un message pour vous: [DESCRIPTION] [URL.QL] Cordialement!', 'admin@gmail.com', '2017-09-11 11:56:43', 'email', 1),
(184, 'ru_RU', 0, 'Добро Пожаловать на [SITE.NAME]!', 'auth-register', '<p>Добро Пожаловать [USER.NAME], мы очень рады, что Вы присоединились к нам! &nbsp;[URL.QL] Запомните детали своего профайла:\r\nEmail: [USER.EMAIL] Пароль: [USER.PWD] У нас больше нет вашего первоначального пароля. С уважением!&nbsp;</p>', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(185, 'ru_RU', 0, 'Изменить пароль на [SITE.NAME]', 'auth-remember', 'Здравствуйте [USER.NAME], перейдите за ссылкой [URL.QL] Спасибо!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(186, 'ru_RU', 0, 'Здравствуйте [USER.NAME]!', 'user-profile-contact', 'Пользователь [EMAIL.SENDER] [EMAIL.FROM], прислал вам сообщение: \r\n\r\n[EMAIL.SUBJECT] \r\n\r\n[EMAIL.BODY]. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(187, 'ru_RU', 0, 'Здравствуйте [USER.NAME]!', 'user-contact', 'С Вами хотят связаться насчёт Вашего объявления: `[AD.NAME]`. Пользователь [EMAIL.SENDER] [EMAIL.FROM], прислал Вам сообщение: [EMAIL.BODY]. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(188, 'ru_RU', 0, '[EMAIL.SENDER] хочет с Вами связаться!', 'contact-admin', 'Здравствуйте Адміністратор, [EMAIL.SENDER]: [EMAIL.FROM], прислал Вам сообщение: [EMAIL.BODY] С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(189, 'ru_RU', 0, 'Наши поздравления, объявление `[AD.NAME]` на [SITE.NAME] было успешно создано!', 'ads-notify', 'Здравствуйте [USER.NAME], Большое спасибо за объявление на [SITE.NAME]! Вы можете редактировать его здесь [URL.QL]. Ваше объявление еще не опубликовано, сначало оно должно быть подтверждено администратором. Приносим извинения за возможные неудобства. Мы рассмотрим его как можно скорее. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(190, 'ru_RU', 0, 'Квитанция за [ORDER.DESC] #[ORDER.ID]', 'new-order', 'Здавствуйте [USER.NAME], Большое спасибо за покупку [ORDER.DESC]. Пожалуйста, продолжите оплату здесь  [URL.CHECKOUT].', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(191, 'ru_RU', 0, 'Объявление `[AD.TITLE]` is out of stock on [SITE.NAME]!', 'out-of-stock', 'Здавствуйте [USER.NAME],\r\n\r\nWhile your ad is out of stock, it is unavailable for others to see. If you wish to increase stock and activate, please follow this link [URL.EDIT].\r\n\r\nRegards!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(192, 'ru_RU', 0, 'Объявление`[AD.TITLE]` продано на [SITE.NAME]!', 'ads-sold', 'Номер заказа: [ORDER.ID] Номер продукта: [PRODUCT.ID] Пожалуйста, проверте свой акаунт на оплату. Для просмотра нажмите здесь [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(193, 'ru_RU', 0, 'Объявление `[AD.TITLE]` создано на [SITE.NAME]!', 'ads-to-admin', 'Для просмотра нажмите здесь [URL.AD]&nbsp;', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(194, 'ru_RU', 0, 'Объявление`[AD.TITLE]` создано на [SITE.NAME]!', 'ads-subscribers', 'Здравствуйте, Вам может быть интересно это объявление, перейдите по ссылке, что бы посмотреть [URL.AD]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(195, 'ru_RU', 0, 'Объявление `[AD.NAME]`создано на [SITE.NAME]!', 'ads-user-check', 'Здравстуйте [USER.NAME], Объявление создано под именем [USER.NAME]! Вы можете просмотреть его за ссылкой [URL.AD]. Если Вы не создавали это объявление, перейдите за ссылкой, чтобы связаться с нами [URL.CONTACT].', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1);
INSERT INTO `yc3_content` (`id_content`, `locale`, `order`, `title`, `seotitle`, `description`, `from_email`, `created`, `type`, `status`) VALUES
(196, 'ru_RU', 0, 'Наши поздравления, объявление `[AD.NAME]` на [SITE.NAME] было успешно создано!', 'ads-confirm', 'Добро Пожаловать [USER.NAME], Большое спасибо за создание объявления на [SITE.NAME]! Пожалуйста, перейдите за ссылкой [URL.QL] чтобы подтвердить. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(197, 'ru_RU', 0, 'Объявление `[AD.TITLE]` выставлено на [SITE.NAME]!', 'ads-purchased', 'Номер заказа: [ORDER.ID] Номер продукта: [PRODUCT.ID] Если у Вас возникли проблемы, пожалуйста, свяжитесь с администратором сайта [SITE.NAME] Перейдите за ссылкой для просмотра [URL.AD]\r\n\r\n[BUYER.INSTRUCTIONS]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(198, 'ru_RU', 0, 'Заканчивается срок публикации Вашего объявления [AD.NAME]', 'ad-to-expire', 'Здравствуйте [USER.NAME], Скоро истечёт срок вашего объявления [AD.NAME], пожалуйста, перейдите за ссылкой чтобы просмотреть [URL.EDITAD]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(199, 'ru_RU', 0, 'Пароль Изменён [SITE.NAME]', 'password-changed', 'Здравствуйте[USER.NAME], Ваш пароль был изменён. Это Вашы новые детали :\r\nEmail: [USER.EMAIL] Пароль: [USER.PWD] У нас больше нет Вашего первоначального пароля. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(200, 'ru_RU', 0, 'Вышел срок публикации Вашего объявления [AD.NAME] ', 'ad-expired', 'Здавствуйте [USER.NAME], Вышел срок публикации Вашего объявления [AD.NAME], Пожалуйста, перейдите за ссылкой для просмотра [URL.EDITAD]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(201, 'ru_RU', 0, '[FROM.NAME] прислал Вам сообщение', 'messaging-user-contact', 'Здравствуйте [TO.NAME], [FROM.NAME] прислал Вам сообщение: [DESCRIPTION] [URL.QL] С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(202, 'ru_RU', 0, 'Новый ответ: [TITLE]', 'messaging-reply', '[URL.QL]\r\n\r\n[DESCRIPTION]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(203, 'ru_RU', 0, 'Здравствуйте [TO.NAME]!', 'messaging-ad-contact', 'С Вами хотят связаться насчёт&nbsp;объявления: `[AD.NAME]`. Пользователь [FROM.NAME], прислал Вам сообщение: [DESCRIPTION] [URL.QL] С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(204, 'ru_RU', 0, 'Срок Вашего тарифного плана [PLAN.NAME] истёк', 'plan-expired', 'Здравствуйте [USER.NAME], Истёк срок Вашего тарифного плана [PLAN.NAME], Пожалуйста, перейдите за &nbsp;ссылкой чтобы просмотрет [URL.CHECKOUT]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(205, 'ru_RU', 0, 'Новый ответ на форуме', 'new-forum-answer', '<p>Новый ответ на форуме<br></p><p><br>&nbsp;&nbsp;<a href="[FORUM.LINK]" >Просмотреть здесь</a><br><br>[FORUM.LINK]<br></p>', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(206, 'ru_RU', 0, 'Новый отзыв на  [AD.TITLE] [RATE]', 'ad-review', '[URL.QL]\r\n\r\n[RATE]\r\n\r\n[DESCRIPTION]', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1),
(207, 'ru_RU', 0, 'Ваше объявление `[AD.NAME]` на [SITE.NAME], активировано', 'ads-activated', 'Здравствуйте [USER.OWNER], Ваше объявление [URL.QL] активировано! Теперь его может увидеть каждый посетитель. Надеемся, что мы не заставили Вас долго ждать. С уважением!', 'admin@gmail.com', '2017-09-11 11:56:44', 'email', 1);
...
(1, 'Sitemap', '0 3 * * *', 'Sitemap::generate', NULL, 'Regenerates the sitemap everyday at 3am', '2017-09-11 11:56:44', '2017-09-11 12:56:48', '2017-09-11 12:56:48', '2017-09-12 03:00:00', 1, 'Memory peak 1.37 MB - Time: 0.65s', 0, 1),
(2, 'Clean Cache', '0 5 * * *', 'Core::delete_cache', NULL, 'Once day force to flush all the cache.', '2017-09-11 11:56:44', '2017-09-11 12:56:49', '2017-09-11 12:56:50', '2017-09-12 05:00:00', 1, NULL, 0, 1),
(3, 'Optimize DB', '0 4 1 * *', 'Core::optimize_db', NULL, 'once a month we optimize the DB', '2017-09-11 11:56:44', '2017-09-11 12:56:50', '2017-09-11 12:57:08', '2017-10-01 04:00:00', 1, NULL, 0, 1),
(4, 'Unpaid Orders', '0 7 * * *', 'Cron_Ad::unpaid', NULL, 'Notify unpaid orders 2 days after was created', '2017-09-11 11:56:44', '2017-09-11 12:57:08', '2017-09-11 12:57:08', '2017-09-12 07:00:00', 1, NULL, 0, 1),
(5, 'Expired Featured Ad', '0 8 * * *', 'Cron_Ad::expired_featured', NULL, 'Notify by email of expired featured ad', '2017-09-11 11:56:44', '2017-09-11 12:57:09', '2017-09-11 12:57:09', '2017-09-12 08:00:00', 1, NULL, 0, 1),
(6, 'Expired Ad', '0 9 * * *', 'Cron_Ad::expired', NULL, 'Notify by email of expired ad', '2017-09-11 11:56:44', '2017-09-11 12:57:09', '2017-09-11 12:57:09', '2017-09-12 09:00:00', 1, NULL, 0, 1),
(7, 'About to Expire Ad', '05 9 * * *', 'Cron_Ad::to_expire', NULL, 'Notify by email your ad is about to expire', '2017-09-11 11:56:44', '2017-09-11 12:57:09', '2017-09-11 12:57:09', '2017-09-12 09:05:00', 1, NULL, 0, 1),
(8, 'Renew subscription', '*/5 * * * *', 'Cron_Subscription::renew', NULL, 'Notify by email user subscription will expire.', '2017-09-11 11:56:44', '2017-09-11 12:57:09', '2017-09-11 12:57:09', '2017-09-11 13:00:00', 1, NULL, 0, 1),
(9, 'Notify new updates', '0 9 * * 1', 'Cron_Update::notify', NULL, 'Notify by email of new site updates.', '2017-09-11 11:56:44', '2017-09-11 12:57:09', '2017-09-11 12:57:10', '2017-09-18 09:00:00', 1, NULL, 0, 1),
(10, 'Generate Access Token', '10 9 1 * *', 'Social::GetAccessToken', NULL, 'Generate Facebook long-lived Access Token.', '2017-09-11 11:56:44', '2017-09-11 12:57:10', '2017-09-11 12:57:10', '2017-10-01 09:10:00', 1, NULL, 0, 1),
(11, 'Algolia Search re-index', '0 * * * *', 'Cron_Algolia::reindex', NULL, 'Re-index everything', '2017-09-11 11:56:44', '2017-09-11 12:57:10', '2017-09-11 12:57:10', '2017-09-11 13:00:00', 1, NULL, 0, 1);
...
(1, 'user', 'Normal user', '2017-09-11 11:56:44'),
(5, 'translator', 'User + Translations', '2017-09-11 11:56:44'),
(7, 'moderator', 'Moderator', '2017-09-11 11:56:44'),
(10, 'admin', 'Full access', '2017-09-11 11:56:44');
...
(1, 'admin', 'admin', 'admin@gmail.com', '376dc50f4511161d3845098e82dbd5a3b560487befa6cddbdbfb96b63d9fa3b9', NULL, 1, 10, NULL, '2017-09-11 11:56:44', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Jermaine Doe', 'jermaine-doe', 'user@gmail.com', 'ade7e433a2a44ea7599136fd9f8ca34d31dcd9c883bcdfb8281c5c9db9294973', NULL, 1, 1, NULL, '2017-09-11 11:59:07', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Gary Doe', 'gary-doe', 'gazzasdasd@gmail.com', 'a5727aab494c3192ca5109ac5707ccda0f504fd4b7bfb419f43d42bb392f8003', NULL, 1, 1, NULL, '2017-09-11 11:59:26', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'John Smith', 'john-smith', 'john@gmail.com', '19f5715943ab18c6713e3886017ac2ffc24d97bdb564ee2e9280351fc00d9deb', NULL, 1, 1, NULL, '2017-09-11 11:59:34', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
